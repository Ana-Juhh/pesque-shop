  ...
  return (
    <footer className="bg-primary text-white pt-16 pb-8 border-t-4 border-secondary">
      <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="text-sm text-white/80 leading-relaxed font-medium">
            A Pesque e Shop é a sua loja especializada em artigos de pesca de alta performance.
            Oferecemos os melhores equipamentos para tornar sua pescaria inesquecível.
          </p>
        ...
        {/* Links */}
        <div>
          <h4 className="font-black uppercase text-[10px] mb-8 border-b-2 border-secondary pb-2 inline-block tracking-[0.2em] text-highlight">
            Institucional
          </h4>
          ...
          <ul className="text-xs text-white/90 space-y-4 font-bold uppercase tracking-widest">
            <li
              ...
              className="hover:text-highlight cursor-pointer transition-colors flex items-center gap-2 group"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 mt-16 pt-8 border-t border-white/10 text-center">
        <p className="text-[10px] text-white/50 font-black uppercase tracking-[0.3em] mb-2">
          © 2026 Pesque e Shop - Todos os direitos reservados
        </p>
        <p className="text-[9px] text-white/30 font-bold uppercase tracking-widest">
          CNPJ: 51.220.315/0001-85
        </p>
      </div>
    </footer>
  );
